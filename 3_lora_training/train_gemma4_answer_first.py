...
Usage:
    # 测试模式
    python train_gemma4_answer_first.py --data data/train_answer_first.json --test

    # 全量训练
    python train_gemma4_answer_first.py --data data/train_answer_first.json --epochs 3
"""
...
DEFAULT_OUTPUT = "models/gemma4-answer-first"
...
class AnswerFirstTrainer:
    ...
    def _pre_tokenize_dataset(self, raw_data):
        """Pre-tokenize，sentiment 在开头（答案优先）"""
...
def main():
    ...
    print(f"Chat template: gemma-4-thinking")
